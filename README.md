...
- <kbd>M-RET</kbd> :: `doentry-mode-meta-return`. similar to `org-meta-return`; when in a list will insert a new list item, when on a heading will insert a new heading. with numbered lists, support
